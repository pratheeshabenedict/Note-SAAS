...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to NoteLuv 🎉');
      navigate('/dashboard');
    } catch (err) {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .auth-input:focus { border-color: var(--brand); box-shadow: 0 0 0 3px color-mix(in srgb, var(--brand) 15%, transparent); }
      ...
      <div className="left-panel" style={{
        ...
        <div style={{ maxWidth: 360, textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--text-secondary)', lineHeight: 1.65, marginBottom: 36 }}>
            Your notes, organized beautifully. No credit card needed.
          </p>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                <svg style={{ width: 12, height: 12, color: 'var(--brand)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              ...
              <input
                ...
                autoComplete="new-password"
              />
              {errors.confirm && <p style={{ fontSize: 12, color: '#ef4444', marginTop: 5 }}>{errors.confirm}</p>}
            </div>
